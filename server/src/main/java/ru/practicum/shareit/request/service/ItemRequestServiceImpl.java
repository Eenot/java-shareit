...
public class ItemRequestServiceImpl implements ItemRequestService {
    ...
    @Override
    public ItemRequestDto createNewRequest(ItemRequestDto requestDto, Long userId) {
        User requester = userValidator.validateUserIdAndReturnIt(userId);
        requestDto.setCreated(LocalDateTime.now());
        itemRequestValidator.validateRequestData(requestDto);
    ...
    public ItemRequestDto getRequestById(Long userId, Long requestId) {
        userValidator.validateUserId(userId);
        ItemRequest request = itemRequestValidator.validateItemRequestIdAndReturnIt(requestId);
